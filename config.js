(function() {
    ...
    NS.NEW_BUILDINGS = [
        ...
        { id: 205, type: 'res', name: "Taverna", cost: { coin: 1 }, reward: { special: 'taverna' }, slots: 3, desc: "1💰 -> Scegli Menu (max 1x tipo)", short: "1💰 ➔ Scegli: 3🧱+3🏆 | 2🪵+7🐄 | 1🏹 | 2⚔️+1🏆" },
        ...
        { id: 206, type: 'vp', name: "Accampamento", cost: {}, reward: { special: 'accampamento' }, slots: 2, desc: "Paga risorse -> ottieni truppe", short: "Scambia: 1🪵->2🏆2⚔️ | 1🐄->2🏹 | 1🪵1🐄5💰->2🏆3⚔️2🏹" },
